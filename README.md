...
1. Mint your character NFT (ERC-1155 using the [Edition Drop](https://docs.web3sdks.com/pre-built-contracts/edition-drop) contract)
2. Purchase a pickaxe NFT from the "Shop" (Another ERC-1155 using an [Edition Drop](https://docs.web3sdks.com/pre-built-contracts/edition-drop) contract)
3. "Equip" (stake) the pickaxe NFT in the [Mining](./contracts/contracts/Mining.sol) contract (built with [web3sdks deploy](https://docs.web3sdks.com/web3sdks-deploy))
4. Start earning "Gold Gems"; ERC-20 tokens (using the [Token](https://docs.web3sdks.com/pre-built-contracts/token) contract)
...
**Check out the Demo here**: https://play-to-earn.web3sdks-template.com/
...
```bash
npx web3sdks create --template play-to-earn
```
...
This project uses 4 contracts built with web3sdks:

| Name      | Contract Type            | Description                    | Link                                                                                                                        |
| --------- | ------------------------ | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| Gold Gems | Token (ERC-20)           | Gold Gems Rewards Token        | [View on web3sdks dashboard](https://web3sdks.com/dashboard/mumbai/token/0x18B18e5D2375c592997e1eaFf6C77A6bd24F5c44)        |
| Pickaxes  | Edition Drop (ERC-1155)  | Pickaxe NFTs                   | [View on web3sdks dashboard](https://web3sdks.com/dashboard/mumbai/edition-drop/0x9d33597aD43bE6295Fe7626baDBF72B862F71bB2) |
| Miners    | Edition Drop (ERC-1155)  | Character NFTs                 | [View on web3sdks dashboard](https://web3sdks.com/dashboard/mumbai/edition-drop/0x16A131b7e5a62E8fe83f0993aAF2ECCaBF519382) |
| Mining    | Custom (web3sdks deploy) | Staking and rewarding contract | [View on web3sdks dashboard](https://web3sdks.com/dashboard/mumbai/0x90E438ba4Bf62573FEC13F792F051E8c96C41636/)             |

Learn how to deploy and configure these contracts using the web3sdks portal documentation:

- [Edition Drop](https://docs.web3sdks.com/pre-built-contracts/edition-drop)
- [Token](https://docs.web3sdks.com/pre-built-contracts/token)
- [web3sdks deploy](https://docs.web3sdks.com/web3sdks-deploy)
...
We can deploy the `Mining` contract using [web3sdks deploy](https://docs.web3sdks.com/web3sdks-deploy)!
...
The application interacts with all `4` of the contracts we created by using the web3sdks SDK.

You can learn more about the web3sdks SDK's here:

- [React](https://docs.web3sdks.com/react)
- [TypeScript](https://docs.web3sdks.com/typescript)

### Connecting to Wallets

To allow users to interact with our contracts and make transactions, we need to connect to their wallets. Firstly, we wrap our application in the `Web3sdksProvider`:
...
On the [index.tsx](./application/pages/index.tsx) page, we use [useMetamask](https://docs.web3sdks.com/react/react.usemetamask) and [useAddress](https://docs.web3sdks.com/react/react.useaddress) to connect and read to the user's wallet.
...
Map / Display each using the [`Web3sdksNftMedia`](https://docs.web3sdks.com/react/react.web3sdksnftmedia) component to display the metadata:
  ...
  <div>
    {ownedPickaxes?.map((p) => (
      <div key={p.metadata.id.toString()}>
        <Web3sdksNftMedia metadata={p.metadata} />
...
The price for each pickaxe NFT is configured with the drop's [claim phases](https://docs.web3sdks.com/pre-built-contracts/edition-drop#setting-claim-phases).
