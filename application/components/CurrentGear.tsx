import { Web3sdksNftMedia, useAddress, useNFT } from "@web3sdks/react";
import { EditionDrop, NFT, SmartContract } from "@web3sdks/sdk";
    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <div style={{ outline: "1px solid grey", borderRadius: 16 }}>
          {playerNft && (
            <Web3sdksNftMedia metadata={playerNft?.metadata} height={"64"} />
          )}
        </div>
        ...
        >
          {pickaxe && (
            // @ts-ignore
            <Web3sdksNftMedia metadata={pickaxe.metadata} height={"64"} />
          )}
        </div>
      </div>
